...
import { download, downloadHover, resume, reversePortrait, arrow } from "../assets";
...
const ExperienceCard = ({ experience }) => (
  ...
  >
    <div>
      ...
      <p className="text-taupe text-[22px] font-semibold font-overcameBold tracking-[1px]">
...
const Experience = () => {
  return (
    <div className="relative flex flex-col">
      {/* Titre dans bordure 8-bit */}
      <div className="w-full" style={{ display: "block" }}>
        <div
          className="border-8bit-title"
          style={{
            display: "block",
            position: "relative",
          ...
          >
            <button
              className="live-demo flex justify-between 
                ...
                ease-in-out"
              onClick={() =>
                window.open("resume link", "_blank") // <- Ton lien ici
              }
              onMouseOver={() => {
                document
